...
//static extern bool GetWindowPlacement(IntPtr hwnd, ref WINDOWPLACEMENT)
/// <summary>
...
public class WindowStateThicknessConverter : IValueConverter
{
	...
	public object Convert(object value, Type targetType, object parameter, string language)
    {
        ...
        // TODO: pass in whether the window is maximized or not.
        //if (value is AppWindow appWin && parameter is string paramStr)
        //{
